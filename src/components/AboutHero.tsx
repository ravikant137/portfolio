...
const INFO_BLOCKS = [
  {
    ...
    subtitle: "Snowflake & IICS Data Engineer  •  4+ Years Experience",
    body: "I help enterprises modernize data platforms with Snowflake, Informatica IICS, and Azure/AWS. My focus: seamless cloud migration, robust ETL pipelines, and real-time analytics that drive measurable business outcomes.",
    color: "#1e90ff",
  },
  {
    id: "lacento",
    title: "Data Engineer @ Lacento Technologies",
    subtitle: "Current  •  Snowflake, IICS, Azure Data Factory",
    body: "Architecting scalable ETL pipelines (IICS, ADF), cloud-native Snowflake data platforms, and advanced analytics solutions. Led multiple data migration projects from legacy to cloud, ensuring zero downtime and cost optimization.",
    color: "#9333ea",
  },
  {
    id: "sigmasoft",
    ...
    body: "Spearheaded Pentaho-to-Snowflake and SAP HANA-to-Azure migrations. Built enterprise ETL workflows with Informatica IICS & ADF, optimized SQL performance, and delivered large-scale sales data migrations with zero downtime.",
    color: "#ff6b2b",
  },
  {
    id: "brand",
    ...
    body: "From legacy migration to cloud-native analytics — every system I build is designed for scale, reliability, and measurable business outcomes. Specializing in Snowflake and Informatica IICS for high-performance, governed data solutions.",
    color: "#00e5a0",
  },
];
